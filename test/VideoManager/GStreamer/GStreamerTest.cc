...
QGC_GST_SKIP_TEST(_testSourceFactoryHttpMjpeg)
QGC_GST_SKIP_TEST(_testSourceFactoryHttpMjpegDelivery)
QGC_GST_SKIP_TEST(_testSourceFactoryRejectsUnsafeHttpMjpegUrl)
QGC_GST_SKIP_TEST(_testSourceFactoryWebSocketJpeg)
QGC_GST_SKIP_TEST(_testWebSocketJpegValidation)
QGC_GST_SKIP_TEST(_testSourceFactoryWebSocketJpegDelivery)
QGC_GST_SKIP_TEST(_testSourceFactoryWebSocketJpegWssTrusted)
QGC_GST_SKIP_TEST(_testSourceFactoryWebSocketJpegWssRejectsUntrusted)
QGC_GST_SKIP_TEST(_testSourceFactoryWebSocketJpegFailedHandshake)
QGC_GST_SKIP_TEST(_testSourceFactoryWebSocketJpegRemoteDisconnect)
QGC_GST_SKIP_TEST(_testSourceFactoryWebSocketJpegImmediateStop)
QGC_GST_SKIP_TEST(_testSourceFactoryRejectsUnsafeWebSocketJpegUrl)
