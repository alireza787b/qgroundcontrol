...
private slots:
    ...
    void _testPipelineDiagnosticRedactionUsesGeneration();
    void _testHttpsMjpegTlsAuth();
    void _testHttpsMjpegRejectsUntrustedCa();
    void _testHttpsMjpegAuthRedirectNotFollowed();
    void _testNetworkJpegValidation();
    ...
    void _testWebSocketEarlyTransportFailureAfterDelayedParenting();
    void _testWebSocketEarlyProtocolFailureAfterDelayedParenting();
    void _testWebSocketJpegTlsAuth();
    void _testWebSocketAuthRedirectNotFollowed();
    void _testWebSocketJpegRejectsUntrustedCa();
